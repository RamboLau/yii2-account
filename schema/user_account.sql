...
create table `trans` (
    ...
    `refunded_money` decimal(16,2) not null default 0.00 comment '退款总金额',  
...
create table `freeze` (
    ...
    `finished_at` int(10) unsigned not null default 0 comment '冻结记录完成时间',
...
create table `trans_refund_log` (
    ...
    `uid` bigint(20) unsigned not null default 0 comment '用户id',
    `trans_id` bigint unsigned not null comment '账单来源交易id',
    `money` decimal(16,2) not null default 0.00 comment '退款金额',  
    `currency` tinyint unsigned not null default 1 comment '币种: 1 人民币',
    `description` varchar(32) not null default '' comment '账单描述',
    `created_at` int(10) unsigned not null default 0 comment '创建时间',
    `updated_at` int(10) unsigned not null default 0 comment '创建时间'
...
alter table `trans_type` AUTO_INCREMENT=4;
